...
namespace Assignment_26
{
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Stream stream = new FileStream(@"C:\Mphasis dot net\Day 21\Assignment 26\employee.bin", FileMode.Create, FileAccess.Write);
            formatter.Serialize(stream, obj); 
            stream.Close();
           
            stream = new FileStream(@"C:\Mphasis dot net\Day 21\Assignment 26\employee.bin", FileMode.Open, FileAccess.Read);
            ...
            using (TextWriter writer = new StreamWriter(@"C:\Mphasis dot net\Day 21\Assignment 26\employee.xml"))
            {
                serializer.Serialize(writer, obj);
            }
            using (TextReader reader = new StreamReader(@"C:\Mphasis dot net\Day 21\Assignment 26\employee.xml"))
            {
